...
html_title = """
    ...
    <center><h1 class="title-test">Streamlit Dashboard</h1></center>"""
# column2
with col2:
...
# column3 : last time update
with col3:
    box_date = str(datetime.datetime.now().strftime("%d %B %Y"))
    st.write(f"Last updated by:  \n {box_date}")

# column4 : Total Sales by Retailer graph
with col4:
...
# column5 : Total Sales Over Time graph
with col5:
